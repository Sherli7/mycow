...
# Prérequis
- [Installer JDK](#emphais)
- [Installer Tomcat](#tomcat)


# **MYCOW APPLICATION VERSION 1.1**


Pour déployer l'application mycow v1.1, il faut installer au préalable les éléments suivants:

## 1. Installation de Tomcat 
Dans le cadre de ce projet, nous allons utiliser tomcat 9
...
```
Une fois l'installation terminée, vérifiez-la en contrôlant la version de Java :
```
java -version
```
...
### Table of Contents
**[Installer Tomcat](#install-tomcat)**<br>
**[Installer JDK11](#usage-instructions)**<br>
